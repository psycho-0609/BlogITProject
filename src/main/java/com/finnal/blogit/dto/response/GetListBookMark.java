...
@Data
public class GetListBookMark {
    private Long id;
    private CustomArticleDTO article;

    public GetListBookMark(Long id, Long articleId, String title, ArticlePublished published, ArticleNew news, ArticleStatus status, Long countView,
