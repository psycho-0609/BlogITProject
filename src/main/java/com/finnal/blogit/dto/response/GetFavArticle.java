...
@Data
@NoArgsConstructor
public class GetFavArticle {
    private Long id;
    private CustomArticleDTO article;

    public GetFavArticle(Long id, Long articleId, String title, ArticlePublished published, ArticleNew news, ArticleStatus status, Long countView,
