...
public class EmailService implements IEmailService {
    ...
    @Override
    @Transactional
    public void approvedPost(ArticleEntity entity,String topic, HttpServletRequest servletRequest) throws UnsupportedEncodingException, MessagingException {
        ...
        message.append("<p>Published Date: <b>").append(entity.getPublishedDate()).append("</b></p>");
    ...
    @Override
    @Transactional
    public void newPostSubmitted(ArticleEntity entity, String topic, List<String> emails, HttpServletRequest servletRequest) throws UnsupportedEncodingException, MessagingException {
        ...
        message.append("<p>You are receiving this email because a new post has been submitted by <a href='").append(linkAuthor).append("'>").append(nameAuthor).append("</a></p>");
        message.append("<p>Title post: <b>").append(entity.getTitle()).append("</b></p>");
        message.append("<p>Category: <b>").append(topic).append("</b></p>");
        message.append("<p>Date: <b>").append(entity.getCreatedDate()).append("</b></p>");
